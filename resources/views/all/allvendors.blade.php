...
<body class="home page-template-default page page-id-907 wp-custom-logo wp-embed-responsive theme-rehub-theme gspbody gspb-bodyfront woocommerce-no-js">
    ...
    <div class="rh-outer-wrap">
                ...
                <div class="main-side page clearfix visual_page_builder full_width" id="content">
                    <div class="rh-fullbrowser">
                        <article class="post mb0" id="page-907">
                            ...
                            <div id="gspb_row-id-gsbp-061718c5-b23d" style="background-image: url('/imgs/bg2.jpg') !important;" class="gspb_row gspb_row-id-gsbp-061718c5-b23d wp-block-greenshift-blocks-row alignfull gspb_row-id-gsbp-061718c5-b23d">
                                <div class="gspb_row__content">
                                    <div id="gspb_col-id-gsbp-24926dee-220e" class="gspb_row__col--12 wp-block-greenshift-blocks-row-column  gspb_col-id-gsbp-24926dee-220e">
                                        <h2 id="gspb_heading-id-gsbp-b613ed98-634a" class="gspb_heading gspb_heading-id-gsbp-b613ed98-634a ">
                                            Top Seafood Vendors​
                                        ...
                                        <div class="wp-block-rehub-searchbox rhpb-searchbox rhpb-942207e4-3a98-4677-a47e-0a7bdf0f6326">
                                            ...
                                            <div class="width-100p position-relative custom_search_box flat_style_form">
                                                <form role="search" class="flowhidden" method="get" id="rh-custom-search-297953464" action="/public/vendors">
                                                    <input type="text" name="src" placeholder="Find vendors" autocomplete="off">
                            ...
                            <!-- <div class="cardx1">
                                <div class="cardx">
                                    <div class="left-container">
                                        <img src="https://cdn.pixabay.com/photo/2020/10/19/09/44/woman-5667299__480.jpg"
                                            alt="Profile Image">
                                    ...
                                    <div class="right-container">
                                        ...
                                        <div class="credit">Made with <span style="color:tomato;font-size:20px;">❤
                                            </span>by<a href="https://www.learningrobo.com/"> Learning Robo</a></div>
                                    </div>
                                </div>
                            </div> -->
                            <!-- 

                            <div class="containerrv card">
        ...
        <!-- <style>
            ...
            .right-container table td:first-child {
                font-weight: bold;
            }
