...
<body>
    ...
    <div class="parent clearfix">
        <div class="bg-illustration">
            ...
            <a href="/">
                <div class="burger-btn" id="nm"> Forget Password
                </div>
            </a>
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <a href="https://rakeshmandal.com" title="logo" target="_blank">
                                <img width="60" src="/tst/grnyellow.png" title="logo" alt="logo">
                            </a>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h1
                                            ...
                                            Reset-link has been sent to your email</h1>
                                        <span
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p
                                ...
                                &copy; <strong>goldenway-international.com</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td style="height:80px;">&nbsp;</td>
