    ...
    <div style="display: flex;  width: 100%; justify-content: space-around; align-items: center;">
        ...
        <div class="navmidcont">
            <h5 class="navmid" style="color: white !important; width: 100%; font-size: 20px; margin-bottom: 0rem !important;">
                <span style="font-size: 23px; margin-left: 5px; font-weight: 600;">GWI Bot</span>
            ...
            <div class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online avatar-onliner">
                        <img style="height: 100%; width: 100%; border-radius: 25px;" src="{{ $v->img ?? '/assets/img/avatars/1.png' }}" alt class="square-circle">
                    </div>
                </a>
                            ...
                            <div class="d-flex">
                                <div class="flex-shrink-0 me-3">
                                    <div class="avatar avatar-online">
                                        <img style="height: 100%; width: 100%;" src="{{ $v->img ?? '/assets/img/avatars/1.png' }}" alt class="rounded-circle">
                                    </div>
                                </div>
