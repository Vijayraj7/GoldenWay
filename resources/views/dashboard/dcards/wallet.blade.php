...
@endif
@if (($snd || isset($adminwlt)) && (!isset($small) || !$small))
<style>
    .wallet-container {
...
<div class="modal fade" style="z-index: 2000 !important;" id="sendModal" tabindex="-1" aria-hidden="true">
    <div style="margin-bottom: 40px !important;" class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="margin-top:50px;">
            <div style="height: 70px; display:flex; align-items:center; padding-left:25px; background-color: #008000; border-radius:7px 7px 0px 0px;" id="modal_send_header" class="modal-header">
                <img id="title-icon" src="https://cdn-icons-png.flaticon.com/256/6001/6001566.png" style="height: 20px; margin-right:8px;">
                <h5 class="modal-title" style="color: #fff; text-transform: uppercase;" style="text-transform:uppercase;" id="coin_name">
                    USDT
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="/sendproduct" onsubmit="return onSendAmount()" method="POST" id="slform" class="silform">
                @csrf
                ...
                <div class="formrow row mb-3">
                    <label style="margin-top: 7px;" class="col-sm-2 form-label" for="basic-icon-default-message">Select Coin</label>
                    <div class="col-sm-10">
                        <select name="coin_type" onchange="handleSelectChange(event)" class="form-select" id="slctplans">
                            <option @if (old('coin_type')=='usdt' ) selected @elseif(old('coin_type')==null) selected @endif value="usdt" id="modalselc">USDT</option>
                            <option @if (old('coin_type')=='bnb' ) selected @endif value="bnb" id="modalselc">BNB</option>
                        </select>
                    </div>
                </div>
                <div class="formrow row mb-3">
                    <label style="margin-top: 7px;" class="col-sm-2 form-label" for="basic-icon-default-message">Network Type</label>
                    <div class="col-sm-10">
                ...
                <div class="formrow row mb-3">
                    <label style="margin-top: 7px;" class="col-sm-2 form-label" for="basic-icon-default-message" id="modalsendtitle">USDT</label>
                    <div class="col-sm-10">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group input-group-merge">
                            <span id="reciever_inputs" class="input-group-text">
                                <img src="https://cdn-icons-png.freepik.com/512/583/583985.png" style="height: 14px;">
                            </span>
                            <input type="text" name="reciever_w" value="{{ old('reciever_w') }}" id="reciever_input" class="form-control phone-mask" placeholder="Wallet Address" aria-label="Wallet Address" aria-describedby="reciever_input">
                            <span id="open-camera" class="input-group-text">
                                <img src="https://mutesoft.com/resources/icons/qr-scanner.svg" style="height: 14px;">
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="formrow row mb-3">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" name="msg" value="{{ old('msg') }}" id="remark_s" class="form-control phone-mask" placeholder="Remark" aria-label="Remark" aria-describedby="remark_s">
                        </div>
                    </div>
                </div>
                <div class="row justify-content-end" style="margin-top: 30px !important;">
                    <div class="" style="display: flex; justify-content: end;">
                        ...
                        <button style="margin-left: 10px;" type="submit" id="send_btn" class="btn btn-primary">SEND USDT</button>
                    </div>
                </div>
            </form>
            <script>
            ...
            <form action="{{ $route ?? '/successproduct' }}" method="POST" id="sendusdtform" enctype="multipart/form-data">
...
<div class="modal fade" style="z-index: 2000 !important;" id="recieveModal" tabindex="-1" aria-hidden="true">
    <div style="margin-bottom: 40px !important;" class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="margin-top:50px;">
            <div style="height: 70px; display:flex; align-items:center; padding-left:25px; background-color: #008000; border-radius:7px 7px 0px 0px;" id="modal_recieve_header" class="modal-header">
                <h5 class="modal-title" style="color: #fff; text-transform: uppercase;" style="text-transform:uppercase;" id="modalrecievetitle">Silver Package</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
