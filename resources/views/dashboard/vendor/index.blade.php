...
<body>
        ...
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                                        ...
                                        <div class="d-flex align-items-end row">
                                            <div class="col-sm-7">
                                                <div class="card-body">
                                                    ...
                                                    <a href="/dashboard/status/deposit"
                                ...
                                <div class="row">
                                    ...
                                    <div style="margin-bottom: 15px;" class="col-lg-12 col-md-12 col-12 mb-12">
                                        ...
                                        <div style="display: flex; justify-content: space-between;">
                                            ...
                                            <div class="gotos">
                                                @if (true)
                                                    <a href="/pdf/gms3.pdf" download="_pdf_gms.pdf"
                                                        class="btn btn-light shr-referral">
                                                        Download PDF
                                                    </a>
                                                @endif
                                            </div>
                                            ...
                                            <div class="gotos" style="display: flex; justify-content: end;">
                                                ...
                                                <a id="downldapp_btn"
                                                    href="https://play.google.com/store/apps/details?id=com.forv.globalmarketstars"
                                                    target="_blank" class="btn btn-light shr-referral">
                                                    Download App
                                                </a>
                                                <script>
                                                    var isandroid = true;
                                                ...
                                                @if (DB::table('customer_subs')->where('csId', $v->id)->sum('sub_amount') > 0)
                                                    <button type="button" id="shcopyButton"
                                                        style="margin-left: 25px;"
                                                        class="btn btn-light shr-referral"
                                                        data-bs-toggle="modal" data-bs-target="#referralDirectionModal">
                                                        Share Referral
                                                    </button>
                                                    ...
                                                    <script>
                                                        function shareReferralWithDirection(direction, userId, userName) {
                                                            var url = "https://" + window.location.host + "/register?ref=" + userId + "&name=" + userName + "&dir=" + direction;
                                        ...
                                        <div class="gotos" style="display: none; justify-content: end;">
                                            ...
                                            @if (true)
                                                <a id="downldapp_btn" href="/dashboard/lott"
                                        ...
                                        <div id="ind_day"
                                            style="display: none; position: absolute; right:0; bottom:0; z-index: 4000;">
                                            <script src="https://unpkg.com/@dotlottie/player-component@latest/dist/dotlottie-player.mjs" type="module"></script>

                                            <script src="https://unpkg.com/@dotlottie/player-component@latest/dist/dotlottie-player.mjs" type="module"></script>

                                            <dotlottie-player
                                                src="https://lottie.host/ea22011b-d4cd-478a-aebc-dd5faf5d2b57/lsFR5H06MR.json"
                                        ...
                                        <div class="card" style="background-color: #0c2820 !important;">
                                            <div class="card-body">
                                                <div style="flex-direction: column;"
                                                    class="card-title d-flex align-items-center justify-content-around">
                                                    <div style="display: flex; align-items: center;">
                                                        <div class="wlt">
                                                            <img style="border-radius: 100px;"
                                                                src="https://icones.pro/wp-content/uploads/2021/05/symbole-de-l-homme-vert.png"
                                                                alt="chart success" class="rounded">
                                                        </div>
                                                        <span class="crd-title" style="margin-right: 4px;">Your Subscription -
                                                            - </span>
                                                    ...
                                                    @if ($totplanafterdiamond >= 1000)
                                                        <div style="display: flex; align-items: center;">
                                                            <span class="crd-title"
                                                                style="margin-right: 4px; font-size:11px !important;"></span>
                                                            <h3 class="card-title"
                                                                style="color:rgb(255, 0, 255) !important; margin-bottom: 0px !important; font-weight:600; font-size:15px !important;">
                                                ...
                                                <div style="border-bottom: none !important; padding-bottom: 0px !important; margin-bottom: 0px !important;"
                                                    class="card-title d-flex align-items-center justify-content-around">
                                                    <div style="display: flex; align-items: center;">
                                                        <!-- <div class="wlt">
                    <img style="border-radius: 100px;" src="https://icones.pro/wp-content/uploads/2021/05/symbole-de-l-homme-vert.png" alt="chart success" class="rounded">
                                                        ...
                                                        <div>
                                                            <span class="crd-title"
                                                                style="margin-right: 2px;">Maximum Stake -</span>
                                                        </div>
                                                        <div>
                                                            <h6 class="card-title"
                                                ...
                                                <div style="border-bottom: none !important; padding-top: 12px !important; margin-top: 12px !important; margin-bottom: 0px !important;"
                                                    class="card-title d-flex align-items-center justify-content-center">
                                                    <button type="button" onclick="openSubscribeModal()"
                                                        style="background-color: #8d6900; border-color: #8d6900; padding: 8px 16px; font-size: 13px;"
            ...
            <div style="border-bottom: none !important; padding-bottom: 0px !important; margin-bottom: 0px !important;" class="card-title d-flex align-items-center justify-content-around">
                ...
                <div>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end"
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="/dashboard/status/deposit">View</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <span style="display: none !important;"
                                                    class="balanc mb-1">Balance</span>
                                                ...
                                                <div
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="cardOpt1">
                                                            <a class="dropdown-item"
                                                                href="/dashboard/status/transactions?pnm=profit">
                                                                View
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="card-body">
                                                <div
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="cardOpt1">
                                                            <a class="dropdown-item"
                                                                href="/dashboard/status/withdraw">
                                                                Withdrawal History
                                                            </a>
                                                            <a class="dropdown-item"
                                                                href="/dashboard/status/transactions">
                                                                Credit History
                                                            </a>
                                                            <a class="dropdown-item" href="/dashboard/lott">
                                                                Purchase Bot
                                                            </a>
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="/dashboard/products/reinvest">
                                                                Restake
                                                            </a>
                                                            <a class="dropdown-item"
                                                                href="/dashboard/withdraw/trnsfr">
                                                                Transfer
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="card-body">
                                                <div
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="cardOpt1">
                                                            <a class="dropdown-item"
                                                                href="/dashboard/withdraw/trnsfrc">
                                                                Transfer
                                                            </a>
                                                            <a class="dropdown-item"
                                                                href="/dashboard/products/reinvest">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="/dashboard/status/withdraw?typ=trnsfr">
                                                                Transfer History
                                                            </a>
                                                            <a class="dropdown-item"
                                                                href="/dashboard/status/transactions?typ=trnsfr">
                                                                All History
                                                            </a>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-6 mb-4">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <h3 class="card-title mb-2">
                                                    <strong>USDT</strong><span
                                                        style="color: blue; font-size: 11px !important;">Pending</span>
                                                </h3>
                                                <h3 class="card-title mb-2">
                                                    {{ number_format(DB::table('customer_transactions')->where('tType', 'levincome')->where('csId', $v->id)->get()->sum('tAmount'), 3) }}
                                                    <strong>USDT</strong><span
                                                        style="color: green; font-size: 11px !important;">Recieved</span>
                                                </h3>
                                                <small style="color: transparent !important;"
                                                    class="notxtsh text-success fw-semibold">
                                                    <i class="bx bx-up-arrow-alt"></i>
                                                    +{{ $admin_profit }}%
                                                </small>
                                            </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-6 mb-4">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <h3 class="card-title mb-2">{{ $dtotalAmoun }} <strong>USDT</strong>
                                                </h3>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-6 mb-4">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                ?>
                                                <span class="balanc mb-1">Total</span>
                                                <h3 class="card-title mb-2">{{ $totalAmoun }} <strong>USDT</strong>
                                                </h3>
                                                <small class="notxtsh text-success fw-semibold">
                                                    <i style="color: transparent;" class="bx bx-up-arrow-alt"></i>
                                                </small>
                        ...
                        <h5 class="pb-1 mb-4" style="display: none !important; color: #fff !important;">GMS Packages
                        </h5>
                            ...
                            <div class="col-md-6 col-lg-4 mb-3">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a class="btn btn-danger" style="width: 100%; margin-top: 10px;"
                                            href="/dashboard/demo/calculator">Calculate</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 mb-3">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="#" onclick="onModalGold()"
                                            class="btn btn-outline-primary deposit-btn">Trade Now</a>
                                        <a class="btn btn-danger" style="width: 100%; margin-top: 10px"
                                            href="/dashboard/demo/calculator?amnt=100&typ=compound">Calculate</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 mb-3">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body"
                                        ...
                                        <button href="#" data-bs-toggle="modal" data-bs-target="#modalCenter"
                        ...
                        @if ($v->email != 'forvcom0@gmail.com')
                            ...
                            @if ($isnotExpired)
                                <div class="modal fade" style="z-index: 2000 !important;" id="modalCenter"
                                        ...
                                        <div class="modal-content" style="margin-top:50px;">
                                            ...
                                            <div style="height: 70px; display:flex; align-items:center; padding-left:25px; background-color: #f9a826ff; border-radius:7px 7px 0px 0px;"
                                                ...
                                                <h5 class="modal-title"
                                                    ...
                                                    style="text-transform:uppercase;" id="seilver_title_text">Silver
                                                    Package</h5>
                                            ...
                                            ?>
                                            <form action="/sendproduct" method="POST" id="slform"
                                                class="silform" enctype="multipart/form-data">
                                                @csrf
    ...
    background-color: var(--brand-color);
                                            ...
                                            <img src="/tst/wlt.jpeg" style="height:200px;" alt="">
                                                ...
                                                <div id="diam_container" class="formrow row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        <select id="diam_amnt" onchange="onDiamText(this.value)"
                                                            class="form-select" name="pamount">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div style="padding: 10px;;">
                                                            <h5 style="margin-bottom: 0px !important; color: #b200c2; font-size: 14px;"
                                                                id="diam_text">Hii</h5>
                                                        </div>
                                                    </div>
                                                    <script>
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            <input type="text" name="pamount"
                                                                value="{{ old('pamount') }}" id="sil_amnt"
                                                                class="form-control phone-mask"
                                                                placeholder="Min 100 USDT or 50 USDT"
                                                                aria-label="Min 100 USDT or 50 USDT"
                            ...
                            @endif
                            <!-- Modal -->
                            <div class="modal fade" id="youTubeModal" style="z-index: 2000 !important;"
                                tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <img height="350"
                                            src="https://media1.giphy.com/media/iHD88spVFkL7mZakwa/giphy.gif?cid=6c09b952wuhq90boqfjywwf4ybxeuvpan10wacws9uwctvdg&ep=v1_internal_gif_by_id&rid=giphy.gif&ct=g"></img>
                                    </div>
                                </div>
                            </div>
                        @endif
