                                ...
                                <div class="card mb-4 premium-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="buyformcontainer" style="display: flex; justify-content:center; width: 100%;">
                                            <form action="/sendproduct" method="POST" onsubmit="return false" id="buyprodct_frm_bbuy" class="row justify-content-center" enctype="multipart/form-data">
                                                @csrf

                                                <input type="hidden" name="csId" value="{{ $v->id }}">

                                                <div class="row mb-3 align-items-center">
                                                    <label class="col-sm-3 col-form-label" for="basic-icon-default-fullname">Contract</label>
                                                    <div class="col-sm-9">
                                                ...
                                                <div style="display: none;" class="row mb-3">
                                                    <label class="col-sm-3 form-label" for="inputGroupSelect02">Package</label>
                                                    <div class="col-sm-9">
                                                ...
                                                <div class="row mb-3">
                                                    <label class="col-sm-3 form-label" for="pamount_input">Amount</label>
                                                    <div class="col-sm-9">
                                                        <div class="input-group input-group-merge">
                                                            <span class="input-group-text"><i class="bx bx-dollar-circle"></i> &nbsp; USDT</span>
                                                            <input type="number" step="any" name="pamount" value="{{ old('pamount') ?? old('amount') }}" id="pamount_input" class="form-control" placeholder="Min 100 USDT and Max {{ number_format(DB::table('customer_subs')->where('csId', $v->id)->sum('sub_amount') * 10, 2) }}" aria-label="Min 100 USDT and Max {{ number_format(DB::table('customer_subs')->where('csId', $v->id)->sum('sub_amount') * 10, 2) }}" aria-describedby="pamount" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    <label class="col-sm-3 form-label" for="remark_input">Remark</label>
                                                    <div class="col-sm-9">
                                                        <div class="input-group input-group-merge">
                                                            <span class="input-group-text"><i class="bx bx-comment-detail"></i></span>
                                                            <input type="text" name="msg" value="{{ old('msg') }}" id="remark_input" class="form-control" placeholder="Remark (Optional)" aria-label="Remark" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row justify-content-end">
                                                    <div class="col-sm-9">
                                                        <button type="button" onclick="onsubmitbuy()" class="premium-btn">
