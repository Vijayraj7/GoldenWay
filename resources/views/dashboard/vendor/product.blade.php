          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span
                  class="text-muted fw-light">Products /</span> All</h4>

              <!-- Content types -->
              <h5 class="pb-1 mb-4">Check out</h5>

              <div class="row mb-5">
                @php
                $plans = json_decode($adminconfig->plans, true);
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                  <div class="card h-100">
                    <img class="card-img-top"
                      ...
                      alt="Card image cap" />
                    <div class="card-body">
                      <h5 class="card-title">{{$planss['name']}}</h5>
                      <p class="card-text">
                        Some quick example text to build on the card title and
                        make up the bulk of the card's content.
                      </p>
                      <a href="/dashboard/products/buy"
                        class="btn btn-outline-primary">USDT
                        {{$planss['amount']}}</a>
                    </div>
                  </div>
                </div>
