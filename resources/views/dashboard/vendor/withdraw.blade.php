    ...
    <head>
        ...
        <style>
            * { font-family: 'Inter', sans-serif; }
            ...
            .layout-page { background: #0d0f1a !important; }
            .content-wrapper { background: #0d0f1a !important; }
            ...
            .wth-card-body { padding: 32px; }

            /* ── Form field ── */
            .wth-field { margin-bottom: 22px; }
            .wth-label {
                color: #8a96b0;
                font-size: 0.78rem;
                font-weight: 600;
            ...
            .wth-select:focus, .wth-input:focus {
            ...
            .wth-select option { background: #1a1d2e; color: #e8eaf0; }
            ...
            .wth-input-inner::placeholder { color: #3d4560 !important; }
            .wth-input-inner:focus { box-shadow: none !important; }
            ...
            .wth-info-value.highlight { color: #f5c518; }
            .wth-info-value.green { color: #4ade80; }
            ...
            .receivable-box .label { color: #4ade80; font-size: 0.78rem; font-weight: 600; }
            .receivable-box .value { color: #4ade80; font-size: 1.1rem; font-weight: 800; }
            ...
            .wth-note i { color: #ff8c00; font-size: 1rem; margin-top: 1px; flex-shrink: 0; }
            .wth-note p {
                color: #8a96b0;
                font-size: 0.78rem;
                line-height: 1.6;
            ...
            .wth-submit-btn:hover::before { left: 100%; }
            .wth-submit-btn:hover {
                transform: translateY(-2px);
                box-shadow: 0 10px 32px rgba(245,197,24,0.5);
            }
            .wth-submit-btn:active { transform: translateY(0); }

            /* ── Processing modal overlay ── */
            #proccess_tic .modal-dialog { max-width: 420px; margin: auto; }
            ...
            #proccess_tic h5 { color: #f5c518; font-weight: 700; margin-top: 12px; }
            #proccess_tic p { color: #6c7a96; font-size: 0.85rem; }
            ...
            #success_tic h3 { color: #4ade80; font-weight: 700; margin: 10px 0 4px; }
            #success_tic h4 { color: #f5c518; font-size: 1.4rem; font-weight: 800; }
            #success_tic .btn { margin-top: 16px; background: #4ade80; color: #0d0f1a; border: none; border-radius: 10px; font-weight: 700; padding: 10px 28px; }

            /* ── Responsive ── */
            @media (max-width: 768px) {
                .balance-amount { font-size: 1.8rem; }
                .wth-card-body { padding: 20px; }
                .balance-banner { padding: 20px; }
            }
        </style>
    </head>
    ...
    <body>
                                                ...
                                                <div class="wth-field">
                                                    ...
                                                    <div class="wth-input-group">
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder="Min 10 — Max {{ $withrawable }}"
                                                        />
                                                    </div>
                                                </div>
        ...
        <script>
            ...
            function onsubmitwth() {
                ...
                if (!am) { alert('Please enter an amount'); return; }
                var amo = Number(am);
                var max = Number('{{ $withrawable }}');
                if (amo < 10) { alert('Minimum withdrawal is 10 USDT'); return; }
                if (amo > max) { alert('Insufficient balance'); return; }
                if (!tpas || tpas.length < 1) { alert('Transaction password is required'); return; }
