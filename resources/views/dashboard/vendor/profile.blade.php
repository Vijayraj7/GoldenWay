                            ...
                            <div class="col-lg-4 col-md-5 mb-4">
                                <div class="premium-profile-card text-center">
                                    <div class="avatar-wrapper">
                                        <img src="{{ $v->img ? $v->img . '?t=' . time() : '/tst/goldenlogo.png' }}" alt="user-avatar" class="avatar-img" id="uploadedAvatar" />
                                    </div>
                                    ...
                                    <div style="border-top: 1px solid rgba(212, 175, 55, 0.1); padding-top: 15px; margin-top: 15px;">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <span style="color: #fff; font-size: 0.8rem; font-weight: 600;">{{ date('Y, ', strtotime($v->created_at)) . strtolower(date('F', strtotime($v->created_at))) . date(', j', strtotime($v->created_at)) }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
