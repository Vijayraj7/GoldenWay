...
<head>
    ...
    <style>
        ...
        * { font-family: 'Inter', sans-serif; box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── Layout overrides ── */
        body, .layout-page, .content-wrapper { background: var(--bg-deep) !important; }
        .container-xxl { max-width: 100% !important; padding: 24px 28px !important; }

        /* ── Wallet card theme override ── */
        .wallet-card,
        .premium-card,
        .wallet-container .card,
        .wallet-container .premium-card { background: #0e1120 !important; border: 1px solid rgba(255,255,255,0.07) !important; box-shadow: 0 12px 40px rgba(0,0,0,0.5) !important; }
        .wallet-container { max-width: 640px !important; }
        .wallet-container .card-body { background: transparent !important; }
        ...
        .stat-card.s-gold::after { background: linear-gradient(90deg, var(--gold), var(--gold2)); }
        .stat-card.s-green::after { background: linear-gradient(90deg, var(--green), #0fbe6a); }
        .stat-card.s-blue::after  { background: linear-gradient(90deg, var(--blue), #2176d9); }
        .stat-card.s-purple::after { background: linear-gradient(90deg, var(--purple), #8b50f5); }
        ...
        .s-gold .stat-icon-wrap  { background: rgba(245,197,24,0.12); color: var(--gold); box-shadow: 0 0 24px rgba(245,197,24,0.15); }
        .s-green .stat-icon-wrap { background: rgba(34,209,122,0.12); color: var(--green); box-shadow: 0 0 24px rgba(34,209,122,0.12); }
        .s-blue .stat-icon-wrap  { background: rgba(79,163,247,0.12); color: var(--blue); box-shadow: 0 0 24px rgba(79,163,247,0.12); }
        .s-purple .stat-icon-wrap { background: rgba(185,122,255,0.12); color: var(--purple); box-shadow: 0 0 24px rgba(185,122,255,0.12); }

        .stat-label { color: var(--text-sub); font-size: 0.72rem; font-weight: 700; text-transform: uppercase; letter-spacing: 1.2px; margin-bottom: 6px; }
        .stat-value { font-size: 1.9rem; font-weight: 800; line-height: 1; color: var(--text-main); letter-spacing: -0.5px; }
        .stat-unit  { font-size: 0.72rem; font-weight: 600; color: var(--text-sub); margin-left: 4px; vertical-align: middle; }
        .stat-hint  { color: var(--text-muted); font-size: 0.7rem; margin-top: 6px; }
        ...
        .btn-search:hover { transform: translateY(-2px); box-shadow: 0 8px 30px rgba(245,197,24,0.4); }
        .btn-clear {
        ...
        .btn-clear:hover { background: rgba(255,255,255,0.09); color: var(--text-main); }
        ...
        .table-header h5 { color: var(--text-main); font-size: 1rem; font-weight: 700; }
        .table-header p  { color: var(--text-sub); font-size: 0.72rem; margin-top: 2px; }
        .count-pill {
            background: rgba(245,197,24,0.1);
            border: 1px solid rgba(245,197,24,0.2);
            color: var(--gold);
        ...
        .data-table tbody tr:hover { background: rgba(245,197,24,0.025); }
        .data-table td {
            padding: 14px 16px;
            font-size: 0.8rem;
            color: #8892ae;
        ...
        /* Cells */
        .cell-num  { color: #5a6480; font-size: 0.7rem; font-weight: 700; text-align: center; min-width: 36px; }
        .cell-date { line-height: 1.55; }
        .cell-date .d1 { color: #c2cce8; font-size: 0.78rem; font-weight: 600; }
        .cell-date .d2 { color: #8892ae; font-size: 0.68rem; }
        ...
        .mem-link:hover { color: var(--gold); }

        .ref-cell { color: #8892ae; font-size: 0.76rem; }
        .ref-cell .ref-name { color: #aab4cc; font-weight: 500; }
        ...
        @keyframes pulse-green {
            0%,100% { box-shadow: 0 0 0 0 rgba(34,209,122,0.5); }
            50%      { box-shadow: 0 0 0 4px rgba(34,209,122,0); }
        }
        .pill-inactive {
            display: inline-flex; align-items: center; gap: 5px;
        ...
        .pill-inactive::before { content: ''; width: 6px; height: 6px; border-radius: 50%; background: var(--red); }
        ...
        .c-purple { color: var(--purple); font-weight: 600; font-size: 0.68rem; }
        .c-orange { color: var(--gold2);  font-weight: 600; }
        .c-red    { color: var(--red);    font-weight: 600; }
        .c-muted  { color: var(--text-muted); }

        /* Phone */
        .phone-v { color: var(--green); font-size: 0.75rem; }
        .phone-u { color: var(--blue);  font-size: 0.75rem; }
        ...
        .total-lbl { color: var(--gold) !important; font-weight: 800 !important; font-size: 0.78rem !important; }
        ...
        .table-footer span { color: var(--text-muted); font-size: 0.72rem; }
        .table-footer .footer-right { display: flex; align-items: center; gap: 8px; }
        .live-dot { width: 7px; height: 7px; border-radius: 50%; background: var(--green); animation: pulse-green 2s infinite; }
    </style>
</head>
<body>
